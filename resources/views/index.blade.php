...
<head>
    ...
    <title>Md. Mahabubur Rahman Portfolio</title>
</head>
<body>
    <div class="container">
  <header>
    ...
    <section class="hero">
      <div class="container">
          <div class="row align-items-center">
              ...
              <div class="col-md-6">
                  <img src="image/myimage2.jpeg" alt="Your Image" class="img-fluid hero-img">
              </div>
          </div>
      </div>
  </section>
  ...
  <div class="project-container">
    <div class="project">
      <img src="image/todo.png" alt="Project 1">
      <h3>Todo app</h3>
    ...
    <div class="project">
      <img src="image/slide-show.png" alt="Project 2">
      <h3>Slide-show</h3>
    ...
    <div class="project">
      <img src="image/guessing-game.png" alt="Project 3">
      <h3>Guessing-game</h3>
